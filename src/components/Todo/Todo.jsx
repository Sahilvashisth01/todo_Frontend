...
//             try {
//                 console.log(`Fetching tasks from: https://todo-backend-0o4p.onrender.com/api/v2/getTask/${id}`);
//                 const response = await axios.get(`https://todo-backend-0o4p.onrender.com/api/v2/getTask/${id}`);
...
const Todo = () => {
    ...
    const submit = async () => {
        ...
        try {
            if (isEditing) {
                const response = await axios.put(`https://todo-backend-0o4p.onrender.com/api/v2/updateTask/${editTaskId}`, {
                    title: inputs.title,
                    body: inputs.body
                });
                ...
                const response = await axios.post("https://todo-backend-0o4p.onrender.com/api/v2/addTask", {
                    title: inputs.title,
                    body: inputs.body,
                    id,
                });
    ...
    const deleteTask = async (taskId) => {
        try {
            await axios.delete(`https://todo-backend-0o4p.onrender.com/api/v2/deleteTask/${taskId}`);
            setTasks(tasks.filter((task) => task._id !== taskId));
            toast.success("Task deleted successfully!");
        } catch (error) {
            console.error("Error deleting task:", error);
